...
CREATE INDEX idx_sessions_expires_at ON auth.sessions(expires_at) WHERE expires_at > CURRENT_TIMESTAMP;
...
VALUES (1, 'Initial schema', md5(pg_read_file('/backend/migrations/up/001_initial_schema.sql', 0, 1000000)::text))
